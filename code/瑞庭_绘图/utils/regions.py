# -*- coding: utf-8 -*-
"""ISO3 → UN continental region mapping for spatial EDA."""
...
ISO_TO_REGION: dict[str, str] = {
    ...
    "TUN": "Africa", "UGA": "Africa", "ZMB": "Africa", "ZWE": "Africa", "SHN": "Africa",
    "AFG": "Asia", "ARM": "Asia", "AZE": "Asia", "BHR": "Asia", "BGD": "Asia",
    "BTN": "Asia", "BRN": "Asia", "KHM": "Asia", "CHN": "Asia", "GEO": "Asia",
    "HKG": "Asia", "IND": "Asia", "IDN": "Asia", "IRN": "Asia", "IRQ": "Asia",
    "ISR": "Asia", "JPN": "Asia", "JOR": "Asia", "KAZ": "Asia", "KWT": "Asia",
    "KGZ": "Asia", "LAO": "Asia", "LBN": "Asia", "MAC": "Asia", "MYS": "Asia",
    "MDV": "Asia", "MNG": "Asia", "MMR": "Asia", "NPL": "Asia", "PRK": "Asia",
    "OMN": "Asia", "PAK": "Asia", "PSE": "Asia", "PHL": "Asia", "QAT": "Asia",
    ...
    "MLT": "Europe", "MDA": "Europe", "MNE": "Europe", "NLD": "Europe",
    ...
    "GRL": "North America", "SPM": "North America", "AIA": "North America", "VGB": "North America",
    "MSR": "North America", "TCA": "North America", "CUW": "North America",
    "ABW": "North America", "SXM": "North America", "BES": "North America",
    ...
    "PYF": "Oceania", "WLF": "Oceania", "COK": "Oceania", "NIU": "Oceania",
}


def region_of(iso: str) -> str:
    return ISO_TO_REGION.get(str(iso).upper(), "Other")
